...
router.get('/', async (req, res) => {
 ...
 //   let num = req.query.number;
    async function 𝙻ιzα мωσℓ_PAIR_CODE() {
        const {
            state,
            saveCreds
              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, 𝙻ιzα мωσℓ User!* 👋🏻

Thanks for using *𝙻ιzα мωσℓ* — your session has been successfully created!
